...
dependency_resolver.register_resolver('maven', maven_resolver)
...
tasks = [
    ...
    Task('package', java_package, require=['test'], help_text='Packages artifacts for the project.'),
